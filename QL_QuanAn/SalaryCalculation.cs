...
namespace QL_QuanAn
{
    public partial class SalaryCalculation : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnSalaryCalculation_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM RPCHAMCONG WHERE THANG = '" + cbMonth.Text + "' AND NAM = '" + cbYear.Text + "'", sql);
            ...
            ReportTimekeeping reportTimekeeping = new ReportTimekeeping();

            reportTimekeeping.DataSource = dt;
            reportTimekeeping.DataMember = "RPCHAMCONG";
            reportTimekeeping.ShowPreview();
